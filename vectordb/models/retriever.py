...
class Retriever(nn.Module):
    def __init__(self, config) -> None:
        ...
        self.model = AutoModel.from_pretrained('sentence-transformers/nli-mpnet-base-v2')
    ...
    def encode(self, inps):
        with torch.no_grad():
            ...
            if isinstance(inps, Sequence):
                inps = self.tokenizer(inps, padding=True, truncation=True, return_tensors='pt', max_length=256)
